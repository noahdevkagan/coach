...
# 6) Sparkle appcast — EdDSA-sign the DMG and emit dist/appcast.xml. The app's
...
APPCAST_ARGS=(--download-url-prefix "https://github.com/${RELEASES_REPO}/releases/download/v${VERSION}/" -o "$DIST_DIR/appcast.xml" "$DIST_DIR")
